    ...
    public async Task Seed()
    {
        ...
        if (!_context.Customers.Any())
        {
            _context.Customers.AddRange(new List<Customer>()
            {
                ...
                new Customer(){Cif = "987654323", Name = "Customer3", CustomerType=CustomerType.CustomerType1, Gender = "Nam", CCCD="125087654323"},
                new Customer(){Cif = "987654324", Name = "Customer4", CustomerType=CustomerType.CustomerType1, Gender = "Nam", CCCD="125087654324"},
                new Customer(){Cif = "987654325", Name = "Customer5", CustomerType=CustomerType.CustomerType1, Gender = "Nam", CCCD="125087654325"},
                new Customer(){Cif = "987654326", Name = "Customer6", CustomerType=CustomerType.CustomerType1, Gender = "Nam", CCCD="125087654326"},
                new Customer(){Cif = "987654321", Name = "Customer1", CustomerType=CustomerType.CustomerType1, Gender = "Nam", CCCD="125087654321"},
                new Customer(){Cif = "987654322", Name = "Customer2", CustomerType=CustomerType.CustomerType1, Gender = "Nam", CCCD="125087654322"},
